...
public class Wrappers {
    int i = 3;
    Integer wi = Integer.valueOf(3); // Integer.valueOf(3);
    ...
    void countBig4(List<Integer> a, int cutoff) {
        long expensive = a.parallelStream().filter((x) -> (x >= cutoff)).count();
    }
    ...
    List<Integer> getFibsBad(int n) {
        List<Integer> fibs = new ArrayList<Integer>(); // C++: std::vector
