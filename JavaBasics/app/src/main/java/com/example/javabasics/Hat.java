...
public class Hat implements AutoCloseable {
    ...
    private float size; // base 2 representation (about 7 decimal digits mantessa ) * 10^(+/- 30)
    private double distTeCenterOfUniverseInAngstroms; // like float 15 digits +/- 300
    ...
    public double getDistTeCenterOfUniverseInAngstroms() {
        return distTeCenterOfUniverseInAngstroms;
    }

    public void setDistTeCenterOfUniverseInAngstroms(double distTeCenterOfUniverseInAngstroms) {
        this.distTeCenterOfUniverseInAngstroms = distTeCenterOfUniverseInAngstroms;
    }
